...
<body>
 <div id="wrap">
    <form action="/PSD1705/folder/09-ThickPhp/index.php/Admin/News/usave" method="post" enctype="multipart/form-data">
          <table>
               <tr>
               ...
               <tr>
                    <td>正文</td>
                    <td>
                        <textarea rows="10" cols="50" name="contents"><?php echo ($arr["contents"]); ?></textarea>
                    </td>
               </tr>
               <tr>
                     <th colspan="2">
